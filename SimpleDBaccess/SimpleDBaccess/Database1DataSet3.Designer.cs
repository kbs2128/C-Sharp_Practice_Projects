...
namespace SimpleDBaccess {
    ...
    public partial class Database1DataSet3 : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentRow AddStudentRow(int Sid, string Sname, string Branch) {
...
namespace SimpleDBaccess.Database1DataSet3TableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Student] WHERE (([Sid] = @Original_Sid) AND ([Sname] = @Origin" +
                "al_Sname) AND ((@IsNull_Branch = 1 AND [Branch] IS NULL) OR ([Branch] = @Origina" +
                "l_Branch)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([Sid], [Sname], [Branch]) VALUES (@Sid, @Sname, @Bra" +
                "nch);\r\nSELECT Sid, Sname, Branch FROM Student WHERE (Sid = @Sid)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [Sid] = @Sid, [Sname] = @Sname, [Branch] = @Branch WHERE (([Sid] = @Original_Sid) AND ([Sname] = @Original_Sname) AND ((@IsNull_Branch = 1 AND [Branch] IS NULL) OR ([Branch] = @Original_Branch)));
SELECT Sid, Sname, Branch FROM Student WHERE (Sid = @Sid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Sid, Sname, Branch FROM dbo.Student";
        ...
        public virtual int Fill(Database1DataSet3.StudentDataTable dataTable) {
        ...
        public virtual Database1DataSet3.StudentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet3.StudentDataTable dataTable = new Database1DataSet3.StudentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet3.StudentDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Sid, string Original_Sname, string Original_Branch) {
        ...
        public virtual int Insert(int Sid, string Sname, string Branch) {
        ...
        public virtual int Update(int Sid, string Sname, string Branch, int Original_Sid, string Original_Sname, string Original_Branch) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Sname, string Branch, int Original_Sid, string Original_Sname, string Original_Branch) {
            return this.Update(Original_Sid, Sname, Branch, Original_Sid, Original_Sname, Original_Branch);
        }
    }
