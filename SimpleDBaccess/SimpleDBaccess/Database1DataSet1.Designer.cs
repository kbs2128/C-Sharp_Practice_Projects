...
namespace SimpleDBaccess {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class ProjectDataTable : global::System.Data.TypedTableBase<ProjectRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProjectRow AddProjectRow(int P_Id, int Sid, string P_name) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProjectRow FindByP_Id(int P_Id) {
        ...
        public partial class ProjectRow : global::System.Data.DataRow {
            ...
            public int P_Id {
                get {
                    return ((int)(this[this.tableProject.P_IdColumn]));
                }
                set {
            ...
            public int Sid {
                get {
                    return ((int)(this[this.tableProject.SidColumn]));
                }
                set {
                    this[this.tableProject.SidColumn] = value;
                }
            }
            ...
            public string P_name {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'P_name\' in table \'Project\' is DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsP_nameNull() {
                return this.IsNull(this.tableProject.P_nameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetP_nameNull() {
                this[this.tableProject.P_nameColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace SimpleDBaccess.Database1DataSet1TableAdapters {
    ...
    public partial class ProjectTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Project] WHERE (([P_Id] = @Original_P_Id) AND ([Sid] = @Origin" +
                "al_Sid) AND ((@IsNull_P_name = 1 AND [P_name] IS NULL) OR ([P_name] = @Original_" +
                "P_name)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Project] ([P_Id], [Sid], [P_name]) VALUES (@P_Id, @Sid, @P_nam" +
                "e);\r\nSELECT P_Id, Sid, P_name FROM Project WHERE (P_Id = @P_Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Project] SET [P_Id] = @P_Id, [Sid] = @Sid, [P_name] = @P_name WHERE (([P_Id] = @Original_P_Id) AND ([Sid] = @Original_Sid) AND ((@IsNull_P_name = 1 AND [P_name] IS NULL) OR ([P_name] = @Original_P_name)));
SELECT P_Id, Sid, P_name FROM Project WHERE (P_Id = @P_Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SimpleDBaccess.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT P_Id, Sid, P_name FROM dbo.Project";
        ...
        public virtual int Fill(Database1DataSet1.ProjectDataTable dataTable) {
        ...
        public virtual Database1DataSet1.ProjectDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet1.ProjectDataTable dataTable = new Database1DataSet1.ProjectDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet1.ProjectDataTable dataTable) {
        ...
        public virtual int Delete(int Original_P_Id, int Original_Sid, string Original_P_name) {
        ...
        public virtual int Insert(int P_Id, int Sid, string P_name) {
        ...
        public virtual int Update(int P_Id, int Sid, string P_name, int Original_P_Id, int Original_Sid, string Original_P_name) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Sid, string P_name, int Original_P_Id, int Original_Sid, string Original_P_name) {
            return this.Update(Original_P_Id, Sid, P_name, Original_P_Id, Original_Sid, Original_P_name);
        }
    }
